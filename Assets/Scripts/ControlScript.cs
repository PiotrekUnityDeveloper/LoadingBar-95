...
public class ControlScript : MonoBehaviour {
    ...
    public Sprite NormalPaint;
    public Sprite FlagPaint;
    public Sprite QuestionMarkPaint;

    //[RequireComponentof(Image)]
    ...
    public void changepaintingmode()
    {
        if(paintmode == 1) //flag
        {
            paintmode = 2;
            imagebtn.gameObject.GetComponent<Image>().sprite = FlagPaint;
        }
        else if(paintmode == 2) //question mark
        {
            paintmode = 3;
            imagebtn.gameObject.GetComponent<Image>().sprite = QuestionMarkPaint;
        }
        else if(paintmode == 3) //normal
        {
            paintmode = 1;
            imagebtn.gameObject.GetComponent<Image>().sprite = NormalPaint;
        }
    }
    ...
    public GameObject ResetWindowObject;

    public void ShowResetWindow()
    {
        ResetWindowObject.SetActive(true);

    }

    public void HideResetWindow()
    {
        ResetWindowObject.SetActive(false);
    }
